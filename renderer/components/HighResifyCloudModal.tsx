...
export const HighResifyCloudModal = ({ show, setShow, setDontShowCloudModal }) => {
  ...
  return (
    <dialog className={`modal ${show && "modal-open"}`}>
      <div className="modal-box flex flex-col text-center items-center gap-4">
        ...
        <p className="text-2xl font-semibold">Introducing HighResify Cloud!</p>
        ...
        <form
          ...
          onSubmit={async (e) => {
            ...
            if (
              ...
              setShow(false);
              alert(
                "Thank you for joining the waitlist! We will notify you when HighResify Cloud is ready for you."
              );
            } else {
