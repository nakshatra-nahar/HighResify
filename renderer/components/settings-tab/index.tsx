...
import { HighResifyCloudModal } from "../HighResifyCloudModal";
    ...
    >
      <div className="flex flex-col gap-2 text-sm font-medium uppercase">
        ...
        <a
          ...
          href="https://docs.HighResify.org/"
          target="_blank"
        >
          🙏 GET HELP
        </a>
        {featureFlags.APP_STORE_BUILD && (
          <a
            className="btn btn-primary"
            href={`mailto:HighResify@gmail.com?subject=HighResify%20Issue%3A%20%3CIssue%20name%20here%3E&body=Device%20Name%3A%20%3CYOUR%20DEVICE%20MODEL%3E%0AOperating%20System%3A%20%3CYOUR%20OPERATING%20SYSTEM%20VERSION%3E%0AHighResify%20Version%3A%20${HighResifyVersion}%0A%0AHi%2C%20I'm%20having%20an%20issue%20with%20HighResify.%20%3CDESCRIBE%20ISSUE%20HERE%3E`}
            target="_blank"
          >
            📧 EMAIL DEVELOPER
          </a>
